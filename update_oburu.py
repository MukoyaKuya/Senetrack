...
senator = Senator.objects.filter(name__icontains="Oburu").first()
if senator:
    perf = senator.perf
    perf.speeches = 304
    perf.sponsored_bills = 1
    perf.passed_bills = 0 # 2nd reading
    perf.total_votes = 20
    perf.attended_votes = 11 # 9 absent out of 20
